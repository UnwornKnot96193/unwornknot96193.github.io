...
<body>
<div class="top"><span class="name">网络聊天室</span></div>
<?php
require_once 'app/app.php';
if(empty(@$_COOKIE[KEYS.'_name'])){
	echo '<div class="write login">                
                <input type="text" value="'.rand_nick().'" id="nick" maxlength="5" placeholder="请输入您的昵称" />                
...
<div class="talk write">                
                <input type="text" id="msg" maxlength="140" placeholder="请输入内容" />                
